...
$query = $db->query("SELECT * FROM serviceproviders WHERE is_Activated = 0", PDO::FETCH_ASSOC);

if (isset($_GET["accept"])) {

    $id = make_safe($_GET["accept"]);
                        ...
                        <table class="table">
                            ...
                            if ($query->rowCount()) {
                                ...
                                foreach ($query as $row) {
                                    ...
                                    print "<td><a href=\"index.php?accept=" . $row['id'] . "\"><i class=\"fas fa-edit\" style=\"padding-right: 10px;\"></i></a><a href=\"index.php?remove=" . $row['id'] . "\"><i class=\"fas fa-times\"></i></a></td>";
                                    print "</tr>";
                                    $counter++;
                                }
                            }
