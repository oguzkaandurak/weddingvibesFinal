...
$queryForUserAppointments = $db->query("SELECT * FROM userappointments WHERE is_active = 1 AND user_id = ". $id, PDO::FETCH_ASSOC);
        ...
        <div class="row">
            <aside class="col-md-3">
                <ul class="list-group">
                    ...
                    <a class="list-group-item" href="userFav.php"> Favoriler </a>
                    <a class="list-group-item active" href="#"> Randevularım </a>
                    <a class="list-group-item" href="login.php"> Çıkış Yap </a>
                </ul>
            </aside> <!-- col.// -->
            <main class="col-md-9">

                <article class="card  mb-3"><div class="card shadow mb-12">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Randevularım</h6>
                        </div>
                        <div class="card-body">
                            <table class="table">
                                ...
                                if ($queryForUserAppointments->rowCount()) {
                                    ...
                                    foreach ($queryForUserAppointments as $row) {
                                        ...
                                        $queryAppointmentUser = $db->prepare('SELECT * FROM serviceproviders WHERE id = ?');
                                        $queryAppointmentUser->execute(array($row["sp_id"]));
                                        ...
                                        print "<td>" . $resultAppointmentUser['vendor_name'] . "</td>";
